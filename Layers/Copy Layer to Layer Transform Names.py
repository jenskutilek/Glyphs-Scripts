#MenuTitle: Copy Layer to Layer, Transform Glyph Names
# -*- coding: utf-8 -*-
...
def transformGlyphName(name):
	return name.replace(".pcap", ".sc")
	...
	def buttonCallback( self, sender ):
		...
		for thisGlyph in selectedGlyphs:
			try:
				...
				targetGlyph = targetFont.glyphs[ transformGlyphName(thisGlyph.name) ]
				if copyBackground == 1:
